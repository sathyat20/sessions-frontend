...
export function VideoTile({ videoId, videoUrl }) {
    ...
    return (
        <>
            <div className="relative text-[1.5rem] font-semibold leading-[1.2em] pr-[1em] flex flex-row justify-center h-[4em] w-32">
                <video
                    id={`video-${videoId}`}
                ...
                <button
                    className="absolute bottom-0 right-[10%] z-[30] scale-100 transition-all w-[1.5em] h-[1.5em] lg:w-[2em] lg:h-[2em] rounded-[50%] border bg-slate-300 border-white hover:scale-110 hover:cursor-pointer active:scale-95 focus:outline-none"
